...
do l = 1,nmax ! l is from i,j 
    ...
    if (mod(l,I).eq.1.and.l.le.I) then  ! ie l=1
        ...
        A(n,l+1) = 0.5*fe-de
        A(n,l+I) = -dn
        A(n,l) = 0.5*fe+de+dw+dn+ds
        b(n) = fw*T_w0+dw*T_w0+ds*T_s0
        n = n + 1
        ...
        A(n,l-1) = -0.5*fw-dw
        A(n,l+I) = -dn
        A(n,l) = de+dw+dn+ds-0.5*fw
        b(n) = (de-fe)*T_e0+ds*T_s0
        n = n + 1
...
!print *, b
print *, del_y, abs(log(del_y))

open(unit=20, file='solution80.txt')
write(20,*)b
close(20)
